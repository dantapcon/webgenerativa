...
import { getPasswordResetRedirectUrl } from "@/lib/utils/url";
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error } = await supabase.auth.resetPasswordForEmail(email, {
        redirectTo: `${getPasswordResetRedirectUrl()}?redirect_to=/auth/update-password`,
      });
      ...
      {success ? (
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Escribe tu correo electrónico y te enviaremos un enlace para restablecer tu
              contraseña
            </CardDescription>
          </CardHeader>
          <CardContent>
